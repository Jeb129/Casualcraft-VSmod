...
namespace CakeBuild
{
    ...
    {
        public const string ProjectName = "casualcraft";
    ...
    public class DefaultTask : FrostingTask<BuildContext>
    {
        public override void Run(BuildContext context)
        {
            Console.WriteLine("Export to Mods? (Y)");
            if (Console.ReadLine() == "Y") 
                context.CopyFileToDirectory($"../Releases/{context.Name}_{context.Version}.zip", 
                    Environment.GetEnvironmentVariable("VINTAGE_STORY") + "/Mods");
        }
    }
}